...
import { ReactComponent as BackWard10Seconds } from "../../assests/image/icon/Rotate10Left.svg";
import { ReactComponent as Forward30Seconds } from "../../assests/image/icon/Rotate30Right.svg";
import { ReactComponent as Heart } from "../../assests/image/icon/Heart.svg";
import { ReactComponent as Playlist } from "../../assests/image/icon/music-playlist.svg";
import { ReactComponent as PlayButtonResponsive } from "../../assests/image/icon/Play.svg";
import { ReactComponent as Pause } from "../../assests/image/icon/pause.svg";
...
const VoiceConsultantation = (prop) => {
  ...
  const backFive = () => {
    progressBar.current.value = Number(
      parseInt(progressBar.current.value) - 10
    );
    changeRange();
  };
                ...
                >
                  {isPlaying ? (
                    ...
                    <div className={styles.playbutton}>
                      {" "}
                      <PlayButtonResponsive onClick={togglePlayPause} />
                    </div>
                  )}
                </div>
                <div
