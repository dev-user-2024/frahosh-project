...
const Signup = () => {
  ...
  return (
    <Box className="signup-box" py={2}>
      <Box
        className="signup-box1-bg"
        display="flex"
        textAlign="center"
      ...
      >
        <Box
          ...
          p={{ xs: 4, md: 5 }}
        >
          <p className="signup-title">خوش آمدی</p>
          <Stack
          ...
          >
            ...
            >
              <img
                ...
                width={20}
              />
              <p className="signup-google-box">ورود با گوگل</p>
            </Button>
            <Button
              sx={{
            ...
            >
              <img
                ...
                alt=""
              />
              <p className="signup-yahoo-box">ورود با یاهو</p>
            </Button>
          </Stack>
          <Box
            display={{ xs: "none", md: "flex" }}
            className="signup-border-section"
          >
            <div className="signup-border1"></div>
            <p className="signup-border-text">یا</p>
            <div className="signup-border2"></div>
          </Box>
          <Formik
            initialValues={{
              mobile: "",
            ...
            {({ values, isSubmitting, errors, setFieldValue, touched }) => (
              <Form>
                ...
                <Stack mt={2} direction={{ xs: "row" }}>
                  <input className="signup-check-box" type="checkbox" />
          ...
          <div className="signup-border3"></div>
