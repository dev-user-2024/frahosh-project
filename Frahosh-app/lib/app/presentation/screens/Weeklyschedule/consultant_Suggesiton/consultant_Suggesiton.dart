...
import '../../../blocs/counsel_program/counsel_program_cubit.dart';
...
class ConsultantSuggesiton extends StatelessWidget {
  ConsultantSuggesiton({super.key});
  final CalendarCubit _calendarCubit = CalendarCubit();
  final CounselProgramCubit _counselProgramCubit = CounselProgramCubit();
  @override
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: BlocBuilder<CounselProgramCubit,
                                CounselProgramState>(
                              bloc: _counselProgramCubit,
