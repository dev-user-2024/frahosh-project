...
import 'package:farahoosh/app/presentation/blocs/my_program/my_program_cubit.dart';
...
class PlannerPage2 extends StatelessWidget {
  PlannerPage2({super.key});
  final CalendarCubit _calendarCubit = CalendarCubit();
  final MyProgramCubit _myProgramCubit = MyProgramCubit();
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      body: Column(
        children: [
          toApp(context: context, title: "برنامه"),
          Expanded(
            child: SizedBox(
              height: size.height,
              width: size.width,
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: BlocBuilder<MyProgramCubit, MyProgramState>(
                              bloc: _myProgramCubit,
