                        ...
                        children: [
                                  ...
                                  child: Stack(
                                    children: [
                                      SizedBox(
                                          width: size.width,
                                          height: 288,
                                          child: DataImages.musicPlayImage
                                              .toPNGImage()),
                                      SizedBox(
                                        width: size.width,
                                        height: 45,
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    Expanded(
                                                      child: const Text(
                                                        "انتخاب موسیقی و بارگذاری آن توسط مدرسه صورت می‌گیرد و فراهوش هیچگونه مسئولیتی در این زمینه ندارد.",
                                                        style: TextStyle(
                                                          fontSize: 12,
                                                          color: SolidColors
                                                              .textTitleWhite,
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      const Text(
                                                        "محمد معتمدی-کهکشان سرخ (آلبوم سربلندان)",
                                                        style: TextStyle(
                                                          fontSize: 12,
                                                          color: SolidColors
                                                              .textTitleWhite,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: SolidColors.black, width: 0.2)),
                            child: const Text(""),
                          ),
                          const SizedBox(
                            height: 30,
