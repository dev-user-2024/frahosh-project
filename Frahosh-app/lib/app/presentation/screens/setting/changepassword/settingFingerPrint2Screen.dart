...
Future<dynamic> SettingFingerPrintScreen2BottomSheet(
        ...
        return Padding(
          ...
          child: Container(
            ...
            children: [
              ...
              const SizedBox(height: 20,),
              '۵ از ۵'.toText(color: SolidColors.black, fontSize: 14,fontWeight: FontWeight.bold),
              ...
              Padding(
                ...
                child: Stack(
                  ...
                  Align(
                    alignment: Alignment.center,
                    child: Padding(
                      padding:  EdgeInsets.only(right: context.widths/5),
                      child: SizedBox(
                        width: context.widths,
