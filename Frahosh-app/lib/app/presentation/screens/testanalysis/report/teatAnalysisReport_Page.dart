...
class TeatAnalysisReportPage extends StatelessWidget {
  final String title;

  TeatAnalysisReportPage(this.title, this._cubit, {Key? key}) : super(key: key);

  final TeatAnalysisReportPage _cubit;
