...
class TicketAgain extends StatelessWidget  {
  const TicketAgain({super.key});
    ...
    return SafeArea(
      ...
      body: Container(
        ...
        child: Column(children: [
          toApp(context: context, title: "سال دوم دبیرستان"),
          Expanded(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: const ButtonWidget(
                              title: 'ارسال تیکت', mainColor: true).toClick(
                                onTap: () {
