import { FormControl, Grid, MenuItem, Pagination, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from '@mui/material'
            ...
            <Grid container>
                    ...
                    <FormProvider {...methods}>
                        <form action="">
                            <div>
                                ...
                                <FormControl >
                                    <Styled.SearchBox>
                                        <Input placeholder="جست و جوی مشاور ..." name="status3" />
                                    </Styled.SearchBox>
                                </FormControl>
                            </div>
                        </form>
                ...
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 700 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                <Styled.StyledTableCell>کد کاربر</Styled.StyledTableCell>
                                <Styled.StyledTableCell>نام و نام خانوادگی</Styled.StyledTableCell>
                                <Styled.StyledTableCell>نوع مشاور</Styled.StyledTableCell>
                                <Styled.StyledTableCell>اخرین مدرک تحصیلی</Styled.StyledTableCell>
                                <Styled.StyledTableCell>تحصیلات</Styled.StyledTableCell>
                                <Styled.StyledTableCell>تاریخ فعالسازی</Styled.StyledTableCell>
                                <Styled.StyledTableCell>شماره همراه</Styled.StyledTableCell>
                        ...
                        <TableBody>
                            <Styled.StyledTableRow>
                                ...
                                <Styled.StyledTableCell>محمد علیزاده </Styled.StyledTableCell>
                                <Styled.StyledTableCell>مشاور تحصیلی</Styled.StyledTableCell>
                                <Styled.StyledTableCell>فوق لیسانس</Styled.StyledTableCell>
                                <Styled.StyledTableCell>روانشناصی تحصیلی</Styled.StyledTableCell>
                                <Styled.StyledTableCell>1402/02/01</Styled.StyledTableCell>
                                <Styled.StyledTableCell>09105849370</Styled.StyledTableCell>
                                <Styled.StyledTableCell sx={{ color: '#11AA63' }}>فعال</Styled.StyledTableCell>
                                <Styled.StyledTableCell sx={{ color: '#11AA63' }}>آنلاین</Styled.StyledTableCell>
