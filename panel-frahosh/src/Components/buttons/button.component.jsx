...
const BUTTON_TYPE_CLASSES = {
  ...
  stop: 'stop',
  consultantBtn:'start',
  consultantReservationBtn:'reserve',
  addSchedule:'add',
  forgottenBtn:'validation',
  surveySubmit: 'survey-submit',
  surveyCancle: 'survey-cancle',
  editstudentprofile:'studentprofile-edit',
  addDashboardSchedule:'Add',
  saveDescription:'saveStuDescription',
  cancelDescription:'cancelStuDescription',
  long:'long',
  little:'little',
  littlenum:'littlenum',
  littlev:'littlev',
