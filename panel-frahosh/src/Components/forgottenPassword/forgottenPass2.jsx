    ...
    <>
      ...
      >
        <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
          ...
          <Box width="100%">
            <Typography mb="1rem">کد اعتبارسنجی که به موبایلت پیامک شده رو اینجا وارد کن.</Typography>
          ...
          <Box className={styles.Box}>
            ...
            <Button buttonType="forgottenBtn" onClick={()=>{changePass()}}>تغییر رمز</Button>
          </Box>
        </Grid>
        <Grid
          item
