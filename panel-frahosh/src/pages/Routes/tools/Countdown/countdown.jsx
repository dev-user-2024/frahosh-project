  ...
  return (
    <div className={styles.mainm}>
      ...
      <div className={styles.inputdiv}>
        <div><label for="name">تاریخ امروز</label><input className={styles.input} type="text" value={currentDate} name="phone" disabled /></div>
        <div><label for="name">تاریخ کنکور</label><input ref={yearRef} className={styles.input} type="text" value="14 تیر 1403" name="phone" disabled /></div>
        </div>
