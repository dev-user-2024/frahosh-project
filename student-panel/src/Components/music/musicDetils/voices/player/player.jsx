...
import imgmusic from "../../../../../assests/image/sarbedaran.png"
    ...
    return (
        <div className={styles.music}>
            ...
            <div className={styles.audioPlayerInfo}>
                ...
                <div className={styles.textonimagewarning}><p>2 مهر 1401</p></div>
                <div className={styles.textonimagealbum}><p>صحبتی درباره اهداف آموزشی سال تحصیلی 1401-1402</p></div>
                </div>
